...
const UnitListingDescriptionEditPage = ({}) => {
    ...
    useEffect(async() => {
        ...
        if (property) {
            ...
            newUnitListing.other_unit_update = "description"
        ...
        <>
            ...
            <div className="section">
                ...
                <div className="title-block"><h1>{property.name}</h1>
                    <div className="subtitle">{unitListing.street_and_unit} Description</div>
                </div>
                ...
                >
                    {({ isSubmitting, values }) => (
                        <Form>
                            <div className="section-table-wrap"><p className="text-center">Update the description for {unitListing.street_and_unit} on this page.</p>
                                ...
                                <div className="section-table">
                                    ...
                                    <div className="form-row">
                                        <FormItem label="" name="description" type="textarea" placeholder="Tell us why this unit is amazing" maxLength={7000} />
                                    </div>
...
export default UnitListingDescriptionEditPage;
